 ...
 */
@WebServlet("/FormVerSolicitudFinalizadaServlet")
public class FormVerSolicitudFinalizadaServlet extends HttpServlet {
    ...
    public FormVerSolicitudFinalizadaServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		AyudaDAOImplementation.getInstance().delete(ay);
